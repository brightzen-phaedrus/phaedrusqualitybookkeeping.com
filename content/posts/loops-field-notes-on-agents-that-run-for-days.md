...
draft: false
tags: ["ai", "quality"]
summary: "Andrej Karpathy's working notes on long-running agent loops — nine rules for letting the model drive. The loop is the unit of leverage, not the prompt."
---
...
*© 2026 A. Karpathy. Personal use of this material is permitted. This is an independent reformatting of working notes on long-running agent loops (loops.md, v060726) into a conference-style document. Freely available; ideas subject to revision as the models change.*
