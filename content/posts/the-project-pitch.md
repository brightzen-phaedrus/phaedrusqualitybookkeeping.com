...
We are a bookkeeping and fractional CFO firm with 500 companies on our platform. We build and maintain financial models for these businesses by hand, in spreadsheets. We are developing an AI system that automates this work: it reads source data from accounting platforms, infers statistical forecasting methods for each line item, and generates a complete financial model — without human intervention. The grant funds development of a $100/month product with free setup, making forecasting accessible to every small business.
...
This is built on the [IFM framework](/posts/what-is-an-ifm/) — a standardized financial modeling schema deployed across 500 small businesses over five years. The IFM defines the canonical structure of a small business's financial model: ~50 metrics spanning revenue, COGS, operating expenses, and balance sheet. This structural prior - knowing what a financial model *should* look like - is what enables automated generation from raw accounting data.

No existing solution combines these three capabilities. AI bookkeeping tools focus on categorization speed. FP&A tools require manual construction and cost $1,000–$5,000/month. Our approach treats the model structure as a known schema and focuses AI on method selection under small-sample conditions, explainability, and human-AI forecast refinement — delivered at $100/month with free setup.
...
- Evaluate whether cross-entity learning (anonymized patterns from the 500-company corpus) improves method selection versus per-entity methods alone
...
We are a bookkeeping and CFO firm, not a pure technology company. We serve 500 companies today through [Weekly Accounting](https://weeklyaccounting.com) and [Phoenix Strategy Group](https://phoenixstrategygroup.com). Our clients are small businesses with $1M–$50M in revenue. They already have structured data and pay for advisory services. Distribution is solved — we are the distribution.

The product: **$100/month, free setup** — a 95% cost reduction versus manual model construction and maintenance.

Broader market: 6 million U.S. businesses on QuickBooks Online. Go-to-market beyond our platform is through accounting firms and fractional CFOs — our existing channel.

Competitors (Mosaic, Runway, Forecastr) target $10M+ companies, require manual construction, and charge $1,000–$5,000/month. AI bookkeeping tools (Pilot, Bench, Digits) categorize transactions, not forecast. No product automates forecast generation from raw data with explainable assumptions at $100/month.

---

## 4. The Company and Team

BrightZen, Inc. is a bookkeeping and fractional CFO firm (dba Weekly Accounting). We serve 500 companies today and are building AI tools to scale the service we deliver by hand.

**John Zdanowski (proposed PI)** — 30 years building financial models for growing companies. Co-founded Phoenix Strategy Group (fund administration, 50+ portfolio companies), co-founded Weekly Accounting (bookkeeping for 80+ small businesses), and designed the IFM framework deployed across 500 companies. Author of *Zen and the Art of Weekly Accounting*. Creator of the SEQ Framework and the [Fourth Statement](/posts/the-fourth-statement/). Background as a sonar engineer - signal detection applied to financial data.
